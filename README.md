...
![img/1569483060374](img/1569483060374.png)

或者

![img/1569483175214](img/1569483175214.png)

生成的input.txt如下:

![img/1569458832310](img/1569458832310.png)
...
1. `$ ./selpg --s 1 --e 1 input.txt`
   ...
   ![img/1569483409603](img/1569483409603.png)

   ![img/1569483442989](img/1569483442989.png)
...
2. `$ ./selpg --s 1 --e 1 < input.txt`
   ...
   ![img/1569483543052](img/1569483543052.png)
...
3. `$ ./selpg --s 10 --e 20 input.txt >output.txt`
   ...
   ![img/1569483829161](img/1569483829161.png)
...
4. `$ ./selpg --s 10 --e 20 input.txt 2>error.txt`
   ...
   ![img/1569484077675](img/1569484077675.png)

   ![img/1569484087645](img/1569484087645.png)

   错误信息为空

   将s 10换成s -10

   ![img/1569494740117](img/1569494740117.png)
...
5. `$ ./selpg --s 10 --e 20 input.txt >output2.txt 2>error.txt`
   ...
   ![img/1569495682908](img/1569495682908.png)
...
6. `$ ./selpg --s 3 --e 5 input.txt >output2.txt 2>/dev/null`
   ...
   ![img/1569498221331](img/1569498221331.png)

   ![img/1569496510105](img/1569496510105.png)
...
![img/1569484474395](img/1569484474395.png)
